...
public class GzipUtils {
    ...
    public static void main(String[] args) throws Exception{
    	...
    	//读取文件
    	String readPath = System.getProperty("user.dir") + File.separatorChar + "Doc" +  File.separatorChar + "IMG_2859.jpg";
        ...
        //写出文件
        String writePath = System.getProperty("user.dir") + File.separatorChar +"Doc"  + File.separatorChar +"receive"+  File.separatorChar + "006.jpg";
